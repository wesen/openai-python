...
import sys
import warnings
from typing import Any, Callable, Dict, Iterable, Optional, Sequence, TextIO, Tuple, Type, TypedDict
...
class LinuxDistribution:
    ...
    lsb_release command.
    """
    def __init__(self, include_lsb: Optional[bool] = ..., os_release_file: str = ..., distro_release_file: str = ..., include_uname: Optional[bool] = ..., root_dir: Optional[str] = ..., include_oslevel: Optional[bool] = ...) -> None:
        """
    ...
    def linux_distribution(self, full_distribution_name: bool = ...) -> Tuple[str, str, str]:
        """
